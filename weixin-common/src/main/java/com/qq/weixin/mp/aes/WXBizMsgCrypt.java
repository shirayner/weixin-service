...
public class WXBizMsgCrypt {
	 ...
	 * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
	 */
	public boolean DecryptMsg_WXQY(String msgSignature, String timeStamp, String nonce, String postData)
			throws AesException {
	 ...
	 * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
	 */
	public boolean verifyURL_WXQY(String msgSignature, String timeStamp, String nonce, String echoStr)throws AesException {
		System.out.println("msgSignature:"+msgSignature);
		System.out.println("timeStamp:"+timeStamp);
		System.out.println("nonce:"+nonce);
		System.out.println("token:"+token);
	...
	public String decryptEchoStr(String text) throws AesException {
